    ...
    return transition(`base => moveUp-${step}`, [
      animate(
        ...
        keyframes([
          ...
          style({
            transform: `translateY(-${step * 100}%) scale(1.1)`,
            zIndex: 1,
            offset: 0.85,
          }),
          style({
            transform: `translateY(-${step * 100}%) scale(1)`,
            zIndex: 1,
            offset: 1,
          }),
        ])
    ...
    return transition(`base => moveRight-${step}`, [
      animate(
        ...
        keyframes([
          ...
          style({
            transform: `translateX(${step * 100}%) scale(1.1)`,
            zIndex: 1,
            offset: 0.85,
          }),
          style({
            transform: `translateX(${step * 100}%) scale(1)`,
            zIndex: 1,
            offset: 1,
          }),
        ])
